    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <select class="form-select question-type">
                <option value="single" selected>Единичный выбор</option>
            ...
            @forelse($answers as $answer)
                <div class="answer-row d-flex align-items-center gap-2 mb-2 p-2 border rounded" data-id="{{ $answer->id ?? 'new_' . uniqid() }}">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input correct-radio" name="correct_answer" {{ ($answer->is_correct ?? false) ? 'checked' : '' }}>
